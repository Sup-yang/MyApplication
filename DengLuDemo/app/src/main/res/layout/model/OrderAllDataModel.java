...
public class OrderAllDataModel {
    ...
    public static void getOrderDataFromNet(Subscriber<List<net.anumbrella.lkshop.model.bean.OrderDataModel>> subscriber, String uid) {
    ...
    public static void publishCommentData(Callback<ResponseBody> responseBodyCallback, net.anumbrella.lkshop.model.bean.CommentOrderDataModel data) {
        OkHttpClient.Builder builder = new OkHttpClient.Builder();
