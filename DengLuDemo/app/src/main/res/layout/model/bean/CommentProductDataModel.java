...
public class CommentProductDataModel implements Parcelable {
    ...
    public static final Creator<net.anumbrella.lkshop.model.bean.CommentProductDataModel> CREATOR = new Creator<net.anumbrella.lkshop.model.bean.CommentProductDataModel>() {
        @Override
        public net.anumbrella.lkshop.model.bean.CommentProductDataModel createFromParcel(Parcel in) {
            return new net.anumbrella.lkshop.model.bean.CommentProductDataModel(in);
        }

        @Override
        public net.anumbrella.lkshop.model.bean.CommentProductDataModel[] newArray(int size) {
            return new net.anumbrella.lkshop.model.bean.CommentProductDataModel[size];
        }
    };
    ...
    public static void setData(ProductDetailData data) {
        net.anumbrella.lkshop.model.bean.CommentProductDataModel.data = data;
    }
    ...
    public static ProductDetailData getProductDetailData() {
        if (data == null) {
            synchronized (net.anumbrella.lkshop.model.bean.CommentProductDataModel.class) {
