...
public class OrderDataModel implements Parcelable {
    ...
    public static final Creator<net.anumbrella.lkshop.model.bean.OrderDataModel> CREATOR = new Creator<net.anumbrella.lkshop.model.bean.OrderDataModel>() {
        @Override
        public net.anumbrella.lkshop.model.bean.OrderDataModel createFromParcel(Parcel in) {
            return new net.anumbrella.lkshop.model.bean.OrderDataModel(in);
        }

        @Override
        public net.anumbrella.lkshop.model.bean.OrderDataModel[] newArray(int size) {
            return new net.anumbrella.lkshop.model.bean.OrderDataModel[size];
        }
    };
