...
public class RecommendContentModel implements Parcelable {
    ...
    public static final Creator<net.anumbrella.lkshop.model.bean.RecommendContentModel> CREATOR = new Creator<net.anumbrella.lkshop.model.bean.RecommendContentModel>() {
        @Override
        public net.anumbrella.lkshop.model.bean.RecommendContentModel createFromParcel(Parcel in) {
            return new net.anumbrella.lkshop.model.bean.RecommendContentModel(in);
        }

        @Override
        public net.anumbrella.lkshop.model.bean.RecommendContentModel[] newArray(int size) {
            return new net.anumbrella.lkshop.model.bean.RecommendContentModel[size];
        }
    };
