...
public interface HttpInterface {
    ...
    Call<ResponseBody> login(@Path("action") String action, @Query("phone") String phoneNumber,
     ...
     */
    @GET("/App/AppShopService/index.php/Home/Index/{action}")
    Observable<List<net.anumbrella.lkshop.model.bean.ProductDataModel>> getProducts(@Path("action") String action);
     ...
     */
    @GET("/App/AppShopService/index.php/Home/Index/{action}")
    Observable<List<net.anumbrella.lkshop.model.bean.BannerDataModel>> getBanners(@Path("action") String action);
     ...
     */
    @GET("/App/AppShopService/index.php/Home/Index/{action}")
    Observable<List<net.anumbrella.lkshop.model.bean.OrderDataModel>> getAllOrderData(@Path("action") String action, @Query("uid") String uid);
     ...
     */
    @GET("/App/AppShopService/index.php/Home/Index/{action}")
    Call<ResponseBody> deleteOrderData(@Path("action") String action, @Query("uid") String uid,
                                       @Query("pid") String pid, @Query("oid") String orderId);
     ...
     */
    @POST("/App/AppShopService/index.php/Home/Index/{action}")
    Call<ResponseBody> publishComment(@Path("action") String action, @Body net.anumbrella.lkshop.model.bean.CommentOrderDataModel commentData);
     ...
     */
    @GET("/App/AppShopService/index.php/Home/Index/{action}")
    Observable<List<net.anumbrella.lkshop.model.bean.CommentProductDataModel>> getCommentData(@Path("action") String action);
